...
def single_passing_xml(tmpdir_factory):
    ...
    <testsuite errors="0" failures="0" name="pytest" skips="0" tests="5" time="1.664">
        ...
        <testcase classname="tests.test_default" file="tests/test_default.py" line="8" name="test_pass[ansible://localhost]" time="0.00372695922852"/>
    </testsuite>
    """
...
def single_fail_xml(tmpdir_factory):
    ...
    <testsuite errors="0" failures="0" name="pytest" skips="0" tests="5" time="1.664">
        ...
        <testcase classname="tests.test_default" file="tests/test_default.py" line="16" name="test_fail[ansible://localhost]" time="0.00335693359375">
...
def single_error_xml(tmpdir_factory):
    ...
    <testsuite errors="0" failures="0" name="pytest" skips="0" tests="5" time="1.664">
        ...
        <testcase classname="tests.test_default" file="tests/test_default.py" line="20" name="test_error[ansible://localhost]" time="0.00208067893982">
...
def single_skip_xml(tmpdir_factory):
    ...
    <testsuite errors="0" failures="0" name="pytest" skips="0" tests="5" time="1.664">
        ...
        <testcase classname="tests.test_default" file="tests/test_default.py" line="24" name="test_skip[ansible://localhost]" time="0.00197100639343">
            <skipped message="unconditional skip" type="pytest.skip">tests/test_default.py:24: &lt;py._xmlgen.raw object at 0x7f0921ff4d50&gt;</skipped>
        </testcase>
    </testsuite>
    """
...
def flat_all_passing_xml(tmpdir_factory):
    ...
    <testsuite errors="0" failures="0" name="pytest" skips="0" tests="5" time="1.664">
        ...
        <testcase classname="tests.test_default" file="tests/test_default.py" line="8" name="test_pass1[ansible://localhost]" time="0.00372695922852"/>
        <testcase classname="tests.test_default" file="tests/test_default.py" line="12" name="test_pass2[ansible://localhost]" time="0.00341415405273"/>
        <testcase classname="tests.test_default" file="tests/test_default.py" line="15" name="test_pass3[ansible://localhost]" time="0.00363945960999"/>
        <testcase classname="tests.test_default" file="tests/test_default.py" line="18" name="test_pass4[ansible://localhost]" time="0.00314617156982"/>
        <testcase classname="tests.test_default" file="tests/test_default.py" line="21" name="test_pass5[ansible://localhost]" time="0.00332307815552"/>
    </testsuite>
    """
...
def flat_mix_status_xml(tmpdir_factory):
    ...
    <testsuite errors="1" failures="1" name="pytest" skips="1" tests="4" time="1.901">
        ...
        <testcase classname="tests.test_default" file="tests/test_default.py" line="12" name="test_pass[ansible://localhost]" time="0.0034921169281"/>
        <testcase classname="tests.test_default" file="tests/test_default.py" line="16" name="test_fail[ansible://localhost]" time="0.00335693359375">
            <failure message="assert False">host = &lt;testinfra.host.Host object at 0x7f0921d98cd0&gt;
...
def suite_mix_status_xml(tmpdir_factory):
    ...
    <testsuite errors="1" failures="1" name="pytest" skips="1" tests="4" time="1.853">
        ...
        <testcase classname="tests.test_default.TestClass" file="tests/test_default.py" line="35" name="test_pass[ansible://localhost]" time="0.00357985496521"/>
        <testcase classname="tests.test_default.TestClass" file="tests/test_default.py" line="38" name="test_fail[ansible://localhost]" time="0.00310778617859">
    ...
    tests/test_default.py:40: AssertionError</failure>
        ...
        <testcase classname="tests.test_default.TestClass" file="tests/test_default.py" line="41" name="test_error[ansible://localhost]" time="0.00223517417908">
    ...
    tests/test_default.py:34: RuntimeError</error>
        ...
        <testcase classname="tests.test_default.TestClass" file="tests/test_default.py" line="44" name="test_skip[ansible://localhost]" time="0.00199604034424">
            <skipped message="unconditional skip" type="pytest.skip">tests/test_default.py:44: &lt;py._xmlgen.raw object at 0x7fb9c904d190&gt;</skipped>
        </testcase>
    </testsuite>
    """
